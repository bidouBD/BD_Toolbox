...
class ConvertPage(ctk.CTkFrame):
    ...
    def _build(self):
        ...
        self._file_sel = FileSelector(c1, label="选择源文件", on_change=self._on_file_selected)
    ...
    def _on_file_selected(self, path):
        ...
        if self._video_info:
            ...
            self._info_lbl.configure(text=f"📄 {Path(path).name}  ·  原体积: {size_str}  ·  原码率: {br_mbps:.2f} Mbps")
